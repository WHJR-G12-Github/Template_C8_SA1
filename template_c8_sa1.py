...
while True:
  ...
  # Check if the value of 'over' is "True"
  
      # Create the text to be displayed using 'gameover_font' and naming it 'gameover_text'
      # Text to be displayed, "True", color are passed as arguments
      
      # Display the 'gameover_text' at the location (100,250)
